...
extern void hq4x_32_rb( u_int32_t * sp, u_int32_t srb, u_int32_t * dp, u_int32_t drb, int Xres, int Yres )
{
    int  i, j, k;
    ...
    int dpL = (drb >> 2);
    int spL = (srb >> 2);
    u_int8_t *sRowP = (u_int8_t *) sp;
    u_int8_t *dRowP = (u_int8_t *) dp;
    u_int32_t yuv1, yuv2;
...
extern void hq4x_32( u_int32_t * sp, u_int32_t * dp, int Xres, int Yres )
{
    u_int32_t rowBytesL = Xres * 4;
